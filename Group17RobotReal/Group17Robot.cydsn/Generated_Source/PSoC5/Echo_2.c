...
*
* \funcusage
*  \snippet Echo_2_SUT.c usage_Echo_2_Write
*******************************************************************************/
...
*
* \funcusage
*  \snippet Echo_2_SUT.c usage_Echo_2_SetDriveMode
*******************************************************************************/
...
*
* \funcusage
*  \snippet Echo_2_SUT.c usage_Echo_2_Read  
*******************************************************************************/
...
* preferred Echo_2_Read() API because the 
* Echo_2_ReadDataReg() reads the data register instead of the status 
...
*
* \funcusage
*  \snippet Echo_2_SUT.c usage_Echo_2_ReadDataReg 
*******************************************************************************/
...
/* If interrupt is connected for this Pins component */ 
    ...
    /*******************************************************************************
    * Function Name: Echo_2_SetInterruptMode
    ****************************************************************************//**
    *
    ...
    *  component. Or you may use Echo_2_INTR_ALL to configure the
    *  interrupt mode of all the pins in the Pins component.       
    *  - Echo_2_0_INTR       (First pin in the list)
    *  - Echo_2_1_INTR       (Second pin in the list)
    *  - ...
    *  - Echo_2_INTR_ALL     (All pins in Pins component)
    *
    * \param mode
    ...
    *
    * \funcusage
    *  \snippet Echo_2_SUT.c usage_Echo_2_SetInterruptMode
    *******************************************************************************/
    void Echo_2_SetInterruptMode(uint16 position, uint16 mode)
    {
		if((position & Echo_2_0_INTR) != 0u) 
		{ 
			 Echo_2_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *
    * \funcusage
    *  \snippet Echo_2_SUT.c usage_Echo_2_ClearInterrupt
    *******************************************************************************/
