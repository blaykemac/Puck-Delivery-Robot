...
void moveForwardThenBackward(int distance, int less_or_great, int ultrasonic_sensor, int speed, int activate_safety){ // less or great usewd for forward check
    
    moveUntil(distance, FORWARD, less_or_great, ultrasonic_sensor, speed, activate_safety);
    moveUntil(distance, BACKWARD, -1 * less_or_great, ultrasonic_sensor, speed, activate_safety);
